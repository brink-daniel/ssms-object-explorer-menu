# How to script data rows as TSQL insert statements

The following query builds tsql insert statements by first querying the [sys.columns](https://learn.microsoft.com/en-us/sql/relational-databases/system-catalog-views/sys-columns-transact-sql?view=sql-server-ver16) and [sys.types](https://learn.microsoft.com/en-us/sql/relational-databases/system-catalog-views/sys-types-transact-sql?view=sql-server-ver16) views to get the schema of a table, then reading and concatenating the data into a tsql insert statement.

![Script as insert statement](../images/ScriptAsInsert.png)
...
begin
	...
	begin
		declare @err2 varchar(8000) = 'Error: Table ' + @table + ' is empty. No rows found to script.';
		raiserror(@err2, 16, 1);
		return;
	end
...
This tsql script can be used with the [SSMS Object Explorer Menu](https://github.com/brink-daniel/ssms-object-explorer-menu) extension.
